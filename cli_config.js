...
const cli_arg = yargs
    ...
    .option('tweets', {
        alias: 't',
        description: "Take a tweet tag in argument and query Twitter for data related to it."
    })
    ...
    .option('account', {
        alias: 'a',
        description: "Take an Account name in argument and query Twitter for data related to it."
    })
    .help().alias('help', 'h')
    .version('v0.1')
    .argv;
